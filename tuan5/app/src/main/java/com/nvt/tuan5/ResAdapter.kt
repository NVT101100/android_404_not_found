...
class ResAdapter(): ListAdapter<Restaurants,ResAdapter.ResViewHolder>(ResDiffUtil()){
    ...
    class ResViewHolder(view:View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindData(res :  Restaurants){
            ...
            Glide.with(itemView).load(res.link).into(resImg)
        }
    }
}